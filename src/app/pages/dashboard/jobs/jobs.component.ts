...
import { ActivityItem, FileItem, Message, UserInfo } from './jobs.model';
...
export class JobsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.pageTitle = [{ label: 'Pages', path: '/' }, { label: 'Professional', path: '/', active: true }];
